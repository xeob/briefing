...
**(B) 사람 판단 검증 — 스크립트가 못 잡는 것:** 뉴스 5분야 채움/시간창/출처 실존/중복 없음 · 키워드 근거 · 특징주 촉매의 사실 여부(팩트체크) · 촉매를 못 찾은 종목의 미확인 표기 정확 · **동반 묶음 안에 "티어 충족 + 개별 촉매 있는" 종목이 남아있지 않은지(있으면 개별 승격 — 특히 4~7% 구간은 기계가 못 잡으니 여기서 확인)** · 날조 0. 문제 있으면 재수집·수정.
