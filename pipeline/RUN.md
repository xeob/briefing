...
- **전일 미국 시장**:
  ...
  - **수치 기준 소스 = investing.com (필수)**: 지수·환율·지표 값은 investing.com historical-data 페이지를 WebFetch로 직접 조회해 확정. 요약 기사 속 수치 사용 금지(오차 발생 실증: 7/1 SOX 13,478→실제 13,353.3, 원/달러 1,547→실제 1,552.9).
    - SOX: investing.com/indices/phlx-semiconductor-historical-data
    - 원/달러: investing.com/currencies/usd-krw-historical-data
    - BTC: investing.com/crypto/bitcoin/historical-data
  - 시장 지표 **6종 고정, 2행×3열 그리드(가로 스크롤 금지)**: 윗줄 美10년물·달러인덱스·원/달러 / 아랫줄 WTI·비트코인·금
